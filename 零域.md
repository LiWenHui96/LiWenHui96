...
## Flutter 3.35 版本前后，CupertinoTextField 的变化

[当字体大小在样式和占位符样式之间不同时，CupertinoTextField 文本不会垂直居中](https://github.com/flutter/flutter/issues/176817)

## 升级至 Flutter 3.27+，踩过的“坑”

a. 自 Flutter 3.27 默认开启 Impeller，如果遇到 Android 加载异常、卡顿等，可参考 [Impeller rendering engine](https://docs.flutter.dev/perf/impeller#android)

`AndroidManifest.xml` 文件中，`<application>` 标签下：
...
b. 自 Flutter 3.27 默认开启 Deep Linking，如果使用第三方插件来处理 Deep Linking，建议关闭默认配置：

[Android](https://docs.flutter.dev/cookbook/navigation/set-up-app-links#2-modify-androidmanifest-xml)

`AndroidManifest.xml` 文件中，`<activity>` 标签下：
```xml
<meta-data
...
[iOS](https://docs.flutter.dev/cookbook/navigation/set-up-universal-links#adjust-ios-build-settings)
...
## <a name="error"/>Mac M系列芯片 只能运行 Arm64 模拟器的解决方案

```
xcodebuild -downloadPlatform iOS -architectureVariant universal
```

参考：[Flutter 在 iOS 26 模拟器跑不起来？其实很简单](https://juejin.cn/post/7560986017034190891)

# 公告

## 对中国 App Store 的 iOS 及 iPadOS 的调整

[App 内购买及付费 App 的标准佣金率将由目前的 30% 改为 25%](https://developer.apple.com/cn/news/?id=dadukodv)
...
[flutter.dev](https://docs.flutter.dev/install/archive)

[flutter.cn](https://docs.flutter.cn/install/archive)

## 版本说明

| Flutter版本号 | Flutter更新公告                                                                                            | Dart版本号 | Dart更新公告                                                                                  |
|:-------------:|:----------------------------------------------------------------------------------------------------------:|:----------:|:---------------------------------------------------------------------------------------------:|
| 3.47.0        | [Flutter 3.47 发布，快来看看有什么更新吧](https://juejin.cn/post/7673029031966474292)                       | 3.13.0     | [Dart 3.13 发布，Pub updates](https://dart.dev/blog/announcing-dart-3-13)                      |
| 3.44.0        | [Flutter 3.44 发布啦，超级大版本更新！！！](https://juejin.cn/post/7641896054782672915)                        | 3.12.0     | [Dart 3.12 发布，Pub updates](https://dart.dev/blog/announcing-dart-3-12)                      |
| 3.41.0        | [Flutter 3.41 发布，快来看看有什么更新吧，这是一个有小惊喜的版本](https://juejin.cn/post/7605490752096829503) | 3.11.0     | [Dart 3.11 发布，Pub updates](https://blog.dart.dev/announcing-dart-3-11-b6529be4203a)         |
...
注：更新公告均引自[恋猫de小郭](https://juejin.cn/user/817692379985752/posts)，FSA全栈行动，[The Dart Blog](https://dart.dev/blog?category=releases)
