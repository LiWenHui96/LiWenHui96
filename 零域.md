...
1. [对中国 App Store 的 iOS 及 iPadOS 的调整](#notice)
2. [升级至 Flutter 3.27+，踩过的“坑”](#error)
...
## <a name="error"/>升级至 Flutter 3.27+，踩过的“坑”
...
## <a name="notice"/>对中国 App Store 的 iOS 及 iPadOS 的调整
